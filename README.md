...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-015-a-project-algorithms.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-015-a-project-algorithms`
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-015-a-project-algorithms/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-015-a-project-algorithms/pulls) e confira que o seu _Pull Request_ está criado
